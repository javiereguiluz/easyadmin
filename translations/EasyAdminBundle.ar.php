...
return [
    ...
    'flash_lock_error' => [
        'message' => 'لقد تم تعديل هذا السجل من قبل مستخدم آخر منذ بدئك بالتحرير.
                لا يمكن حفظ تغييراتك لمنع فقدان البيانات.
                %link_start%انقر هنا للـ %reload_text%%link_end% والحصول على أحدث نسخة.',
